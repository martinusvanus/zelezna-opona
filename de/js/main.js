...
function onEachFeature(feature, layer) {
    layer.on('click', function () {
        //formátuje popupy
        document.getElementById("popupcontent").innerHTML = "<dl><dt>Name</dt><dd>" + feature.properties.vlastni_jmeno + " " + feature.properties.prijmeni_ini + "</dd><dt>Nationalität</dt><dd>" + feature.properties.statni_prislusnost + "</dd><dt>Jahr des Vorfalls</dt><dd>" + feature.properties.rok + "</dd><dt>Verantwortliche Abteilung</dt><dd>" + feature.properties.utvar_incidentu + "</dd></dl><dl style='margin-left: 15px;'><dt>Alter</dt><dd>" + feature.properties.vek_h + "</dd><dt>Heimatbezirk</dt><dd>" + feature.properties.okres_bydliste_cz + "</dd><dt>Richtung der Überschreitung</dt><dd>" + feature.properties.smer_prechodu + "</dd><dt>Todesursache</dt><dd>" + feature.properties.umrti + "</dd></dl>";
        $("#popup").stop();
        $("#popup").fadeIn("fast");
